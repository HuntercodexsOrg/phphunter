...
<!--jsHunter Library-->
<script src="<?=$app->getLibPathInstallation();?>/js/jsHunter.js" type="text/javascript"></script>
<script src="<?=$app->getLibPathInstallation();?>/js/jsHunter-ui.js" type="text/javascript"></script>
