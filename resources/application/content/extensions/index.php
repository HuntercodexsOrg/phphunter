...
<!--jsHunter Library-->
<script src="<?=$this->getLibPathInstallation();?>/js/jsHunter.min.js" type="text/javascript"></script>
<script src="<?=$this->getLibPathInstallation();?>/js/jsHunter-ui.min.js" type="text/javascript"></script>
